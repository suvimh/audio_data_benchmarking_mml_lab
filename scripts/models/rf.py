...
def run(
    ...
    print_metrics_summary(train_metrics, "RF (train)")
    print_metrics_summary(val_metrics, "RF (validation)")

    metrics_path = output_dir / "metrics.csv"
    save_metrics_csv(val_metrics, metrics_path, "rf", {"split": "validation"})
    save_metrics_csv(train_metrics, metrics_path, "rf", {"split": "train"})
